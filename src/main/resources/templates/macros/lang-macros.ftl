...
<#macro fetchMultiLangContent var={}><#if var.hasLocale(lang)><#assign langContent=var.getData(lang)><#else><#assign langContent=""><@writeError "missingValue"></@writeError></#if></#macro>
