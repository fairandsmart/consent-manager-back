...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exslt="http://exslt.org/common" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:template match="processingConsent|consent" name="processingConsent">
        ...
        <fo:block color="#3F3F3F" font-size="10pt" margin-bottom="5pt"><xsl:value-of select="data"/></fo:block>
        <fo:block color="#3F3F3F" font-size="10pt" margin-bottom="5pt"><xsl:value-of select="retention/fullText"/></fo:block>
        <fo:block color="#3F3F3F" font-size="10pt" margin-bottom="5pt"><xsl:value-of select="usage"/></fo:block>
    ...
    <xsl:template match="preferenceConsent" name="preferenceConsent">
        <xsl:variable name="lang" select="/receipt/language" />
        <fo:block font-weight="bold" margin="10pt 0">
    ...
    <xsl:template match="conditionsConsent" name="conditionsConsent">
        <xsl:variable name="lang" select="/receipt/language" />
        <fo:table table-layout="fixed" width="100%" margin="10pt 0">
            <fo:table-column column-width="proportional-column-width(1)"/>
            <fo:table-column column-width="proportional-column-width(1)"/>
