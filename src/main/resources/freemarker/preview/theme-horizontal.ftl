<div class="left">
    ...
    <div class="left-content">
        <div class="header">
            ...
            <p class="header-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et libero eu augue
                placerat bibendum auctor ac elit. Duis imperdiet metus felis, laoreet porta dolor faucibus nec. Donec in
                diam tincidunt, commodo erat sit amet, congue ipsum. Nullam venenatis ipsum nibh, vel viverra tortor
                venenatis ut. Morbi id urna quis lorem porta sodales vitae at leo. Praesent sed lorem rutrum, facilisis
    ...
    <div class="processing-list">
        ...
        <div class="processing">
            ...
            <div class="item-wrapper">
                ...
                <p class="processing-body">Donec dignissim cursus euismod. Donec luctus ante sed nibh dictum, ut
                    ...
                    consequat, massa leo pharetra nisl, vel semper felis est id metus.</p>
            </div>
        ...
        <div class="footer">
            <div class="footer-body">
                Nulla in aliquet elit. Quisque ultricies hendrerit mi accumsan lobortis. Mauris elementum ipsum vitae
                euismod accumsan. Duis eget placerat mi.
            </div>
