...
<div class="treatments">
    ...
    <div class="treatment">
        ...
        <div class="item-wrapper">
            ...
            <p class="treatment-body">Donec dignissim cursus euismod. Donec luctus ante sed nibh dictum, ut imperdiet
        ...
        <div class="item-wrapper">
            ...
            <p class="treatment-body">Sed suscipit nec orci ac fermentum. Etiam ut urna diam. In rutrum tortor magna,
    ...
    <div class="treatment">
        ...
        <div class="item-wrapper">
            ...
            <p class="treatment-body">Vestibulum ac augue et sapien accumsan viverra. Vestibulum ante ipsum primis in
