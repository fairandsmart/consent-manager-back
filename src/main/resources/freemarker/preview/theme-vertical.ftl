...
<div class="processing-list">
    <div class="header">
        ...
        <p class="header-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et libero eu augue placerat
            bibendum auctor ac elit. Duis imperdiet metus felis, laoreet porta dolor faucibus nec. Donec in diam
            tincidunt, commodo erat sit amet, congue ipsum. Nullam venenatis ipsum nibh, vel viverra tortor venenatis
            ut. Morbi id urna quis lorem porta sodales vitae at leo. Praesent sed lorem rutrum, facilisis turpis at,
            viverra lorem. Mauris lorem justo, vulputate quis ipsum id, vestibulum efficitur sapien.</p>
    ...
    <div class="processing">
        ...
        <div class="item-wrapper">
            ...
            <p class="processing-body">Nunc fringilla eros nec elit pellentesque mattis. In magna lacus, faucibus non
                augue vel, aliquet mollis arcu. Donec nulla nisl, ullamcorper et augue eget, dapibus feugiat nisl. In
                vitae ligula commodo, blandit massa sit amet, tincidunt est. Nullam ut sapien ut lacus iaculis
                tincidunt. Ut et pellentesque quam, at molestie orci.</p>
        </div>

        <div class="item-wrapper">
            <h4>Pellentesque maximus congue ultricies</h4>
            <p class="processing-body">Donec dignissim cursus euismod. Donec luctus ante sed nibh dictum, ut imperdiet
                mauris eleifend. Pellentesque nec felis at tellus porta dapibus et sit amet lacus. In mauris tellus,
                venenatis euismod ipsum vel, blandit ornare neque. Vestibulum ante ipsum primis in faucibus orci luctus
                et ultrices posuere cubilia curae; Praesent aliquam, libero eget tristique consequat, massa leo pharetra
                nisl, vel semper felis est id metus.</p>
        </div>

        <div class="item-wrapper">
            <h4>Fusce molestie nisi sed molestie tincidunt</h4>
            <p class="processing-body">Sed suscipit nec orci ac fermentum. Etiam ut urna diam. In rutrum tortor magna,
                non auctor massa interdum id. Maecenas a imperdiet turpis. Pellentesque ac imperdiet lorem. Integer
                porta nulla nec interdum facilisis. Phasellus sit amet rutrum mauris. Duis et tellus cursus, rhoncus
    ...
    <div class="processing">
        ...
        <div class="item-wrapper">
            ...
            <p class="processing-body">Nulla quis placerat diam. Vivamus turpis nulla, sodales at luctus sed, aliquet
                quis odio. Sed sit amet bibendum quam. Vestibulum nec nisl sodales libero malesuada auctor a at elit.
                Maecenas in finibus ante, ut egestas orci. Maecenas iaculis sagittis orci. Sed eget nulla nulla.
                Vestibulum eros arcu, lobortis accumsan sem rhoncus, mollis commodo odio.</p>
        </div>
        ...
        <div class="item-wrapper">
            ...
            <p class="processing-body">Vestibulum ac augue et sapien accumsan viverra. Vestibulum ante ipsum primis in
                faucibus orci luctus et ultrices posuere cubilia curae; Aenean accumsan quam non massa luctus, a
                condimentum ipsum bibendum. Curabitur rutrum mauris et odio mollis faucibus. Duis fringilla blandit sem,
