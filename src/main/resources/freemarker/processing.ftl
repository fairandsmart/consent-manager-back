    ...
    <#-- Retention -->
        <div class="item-wrapper">
            <p class="processing-body">
                <@valueOrError langContent.retention "missingValue"></@valueOrError> <@valueOrError langContent.retentionDuration "missingValue"></@valueOrError> <@readBundle langContent.retentionUnit "missingValue"></@readBundle>.
            </p>
        </div>
