...
public class InformationsResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response createInformation(@Valid CreateInformationDto dto, @Context UriInfo uriInfo) throws ConsentManagerException {
        ...
        //TODO load information to include in content
